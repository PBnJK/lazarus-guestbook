...
begin
  Application.MessageBox('Guest Book: por Pedro;' + LineEnding + '04/06/2023;' + LineEnding + LineEnding + 'Feito em Pascal com o Lazarus;' + LineEnding + LineEnding + 'Leia o README.md!!', 'Créditos', $00000040);
end;
